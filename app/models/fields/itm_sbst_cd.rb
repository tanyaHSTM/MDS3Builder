class ItmSbstCd 
  ...
  def set_values_for_type(klass)
    ...
    when "MdsPpsSos" then return "NP"
    when "MdsPpsEos" then return "NP"
    ...
    when "CorrectionOfPpsSos" then return "NP"
    when "CorrectionOfPpsEos" then return "NP"
    ...
    when "InactivationOfPpsSos" then return "XX"
    when "InactivationOfPpsEos" then return "XX"
