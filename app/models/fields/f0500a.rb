class F0500a
  ...
  def initialize
    @name = "Interview for Activity Preferences: Ask resident: While you are in this facility, how important is it to you to have books, newspapers, and magazines to read? (F0500a)"
    @field_type = DROPDOWN
    @node = "F0500A"
