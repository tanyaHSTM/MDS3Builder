class F0400d
  ...
  def initialize
    @name = "Interview for Daily Preferences: Ask resident: While you are in this facility, how important is it to you to have snacks available between meals? (F0400d)"
    @field_type = DROPDOWN
    @node = "F0400D"
