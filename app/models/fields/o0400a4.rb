class O0400a4
  ...
  def initialize
    @name = "Speech-Language Pathology and Audiology Services - Number of days this therapy was administered for at least 15 minutes
             a day in the last 7 days (O0400a4)"
    @field_type = DROPDOWN
    @node = "O0400A4"
