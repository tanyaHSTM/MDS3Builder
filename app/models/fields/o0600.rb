class O0600
  ...
  def initialize
    @name = "Physician Examinations: Over the last 14 days, on how many days did the physician (or authorized assistant or practitioner) examine the resident? (O0600)"
    @field_type = DROPDOWN
    @node = "O0600"     
