class GG0170e1
  ...
  def initialize
    @name = "Mobility - Chair/bed-to-chair transfer (Start of Stay Performance) - The ability to safely transfer to and from a bed to a chair (or wheelchair) (GG0170e1)"
    @field_type = DROPDOWN
    @node = "GG0170E1" 
