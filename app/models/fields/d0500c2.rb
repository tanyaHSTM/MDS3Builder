class D0500c2 
  ...
  def initialize
    @name = "Staff Assessment of Resident Mood (PHQ-9-OV): Over last two weeks, how often has resident had trouble falling or staying asleep, or sleeping too much? (D0500c2)"
    @field_type = DROPDOWN
    @node = "D0500C2" 
