class O0500e
  ...
  def initialize
    @name = "Restorative Nursing Programs (Training & Skill Practice): Transfer  - Number of days this restorative program was performed (for at least 15 minutes 
             a day) in the last 7 days (O0500e)"
    @field_type = DROPDOWN
    @node = "O0500E"     
