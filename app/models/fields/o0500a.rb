class O0500a
  ...
  def initialize
    @name = "Restorative Nursing Programs: Range of motion (passive) - Number of days this restorative program was performed (for at least 15 minutes 
             a day) in the last 7 days (O0500a)"
    @field_type = DROPDOWN
    @node = "O0500A"     
