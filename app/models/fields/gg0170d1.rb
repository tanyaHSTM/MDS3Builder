class GG0170d1
  ...
  def initialize
    @name = "Mobility - Sit to stand (Start of Stay Performance) - The ability to safely come to a standing position from sitting in a chair or on the side of the bed (GG0170d1)"
    @field_type = DROPDOWN
    @node = "GG0170D1" 
