class O0500j
  ...
  def initialize
    @name = "Restorative Nursing Programs (Training & Skill Practice): Communication  - Number of days this restorative program was performed (for at least 15 minutes 
             a day) in the last 7 days (O0500j)"
    @field_type = DROPDOWN
    @node = "O0500J"     
