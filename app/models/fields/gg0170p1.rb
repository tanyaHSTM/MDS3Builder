class GG0170p1
  ...
  def initialize
    @name = "Mobility - Picking up object (Start of Stay Performance) - The ability to bend/stoop from a standing position to pick up a small object, such as a spoon, from the floor. (GG0170p1)"
    @field_type = DROPDOWN
    @node = "GG0170P1" 
