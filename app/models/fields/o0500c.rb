class O0500c
  ...
  def initialize
    @name = "Restorative Nursing Programs: Splint or brace assistance - Number of days this restorative program was performed (for at least 15 minutes 
             a day) in the last 7 days (O0500c)"
    @field_type = DROPDOWN
    @node = "O0500C"     
