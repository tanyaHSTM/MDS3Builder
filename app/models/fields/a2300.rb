class A2300 
  ...
  def set_values_for_type(klass)
    ...
    when "MdsDischargeRna" then return date9.strftime("%Y%m%d")
    when "MdsDischargeRa" then return date9.strftime("%Y%m%d")
    when "MdsDeath" then return date9.strftime("%Y%m%d")
    when "MdsPps5Day" then return date3.strftime("%Y%m%d")
    when "MdsPps14Day" then return date4.strftime("%Y%m%d")
    when "MdsPps30Day" then return date5.strftime("%Y%m%d")
    when "MdsPps60Day" then return date6.strftime("%Y%m%d")
    when "MdsPps90Day" then return date7.strftime("%Y%m%d")
    when "QP017AdmissionPos" then return date1.strftime("%Y%m%d")
    when "QP017QuarterlyPos" then return date8.strftime("%Y%m%d")
