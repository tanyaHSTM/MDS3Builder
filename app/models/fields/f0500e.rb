class F0500e
  ...
  def initialize
    @name = "Interview for Activity Preferences: Ask resident: While you are in this facility, how important is it to you to do things with groups of people? (F0500e)"
    @field_type = DROPDOWN
    @node = "F0500E"
