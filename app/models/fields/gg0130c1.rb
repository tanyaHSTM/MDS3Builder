class GG0130c1
  ...
  def initialize
    @name = "Self-Care - Toileting Hygiene (Start of Stay Performance) - The ability to maintain perineal hygiene, adjust clothes before and after voiding or having a bowel movement. If managing an ostomy, include wiping the opening but not managing equipment. (GG0130c1)"
    @field_type = DROPDOWN
    @node = "GG0130C1" 
