class A2200 
  ...
  def set_values_for_type(klass)
    ...
    when "CorrectionOfPps14Day" then return date6.strftime("%Y%m%d")
    when "CorrectionOfPps30Day" then return date7.strftime("%Y%m%d")
    when "CorrectionOfPps60Day" then return date8.strftime("%Y%m%d")
    when "CorrectionOfPps90Day" then return date9.strftime("%Y%m%d")
