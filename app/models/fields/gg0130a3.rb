class GG0130a3
  ...
  def initialize
    @name = "Self-Care - Eating (Discharge Performance) - The ability to use suitable utensils to bring food to the mouth and swallow food once the meal is presented on a table/tray (GG0130a3)"
    @field_type = DROPDOWN
    @node = "GG0130A3" 
