class F0400f
  ...
  def initialize
    @name = "Interview for Daily Preferences: Ask resident: While you are in this facility, how important is it to you to have your family or a close friend involved in discussions about your care? (F0400f)"
    @field_type = DROPDOWN
    @node = "F0400F"
