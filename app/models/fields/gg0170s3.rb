class GG0170s3
  ...
  def initialize
    @name = "Mobility - Wheel 150 feet (Discharge Performance) - Once seated in wheelchair/scooter, can wheel at least 150 feet in a corridor or similar space (GG0170s3)"
    @field_type = DROPDOWN
    @node = "GG0170S3" 
