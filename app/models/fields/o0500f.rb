class O0500f
  ...
  def initialize
    @name = "Restorative Nursing Programs (Training & Skill Practice): Walking  - Number of days this restorative program was performed (for at least 15 minutes 
             a day) in the last 7 days (O0500f)"
    @field_type = DROPDOWN
    @node = "O0500F"     
