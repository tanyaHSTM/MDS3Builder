class O0500g
  ...
  def initialize
    @name = "Restorative Nursing Programs (Training & Skill Practice): Dressing and/or grooming  - Number of days this restorative program was performed (for at least 15 minutes 
             a day) in the last 7 days (O0500g)"
    @field_type = DROPDOWN
    @node = "O0500G"     
