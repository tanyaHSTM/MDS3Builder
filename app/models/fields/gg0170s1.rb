class GG0170s1
  ...
  def initialize
    @name = "Mobility - Wheel 150 feet (Start of Stay Performance) - Once seated in wheelchair/scooter, the ability to wheel at least 150 feet in a corridor or similar space (GG0170s1)"
    @field_type = DROPDOWN
    @node = "GG0170S1" 
