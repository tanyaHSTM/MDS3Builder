class O0500i
  ...
  def initialize
    @name = "Restorative Nursing Programs (Training & Skill Practice): Amputation/prostheses care - Number of days this restorative program was performed (for at least 15 minutes 
             a day) in the last 7 days (O0500i)"
    @field_type = DROPDOWN
    @node = "O0500I"     
