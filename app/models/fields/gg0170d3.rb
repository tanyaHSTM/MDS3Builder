class GG0170d3
  ...
  def initialize
    @name = "Mobility - Sit to stand (Discharge Goal) - The ability to safely come to a standing position from sitting in a chair or on the side of the bed (GG0170d3)"
    @field_type = DROPDOWN
    @node = "GG0170D3" 
