...
module Qps::Qp119
  ...
  def apply_requested_qp_attributes(pos_or_neg, type)
    if pos_or_neg == "pos" && type == "Pps5Day"
      set_G0110B1_pos; set_O0400B4_pos; set_O0400C4_pos;
    elsif pos_or_neg == "pos" && type == "Pps30Day"
      set_G0110B1_pos_30day; set_O0400B4_pos; set_O0400C4_pos;
